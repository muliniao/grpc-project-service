...
func RegisterUserAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UserAPIServer) error {
	...
	mux.Handle("GET", pattern_UserAPI_GetUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/core.v1.UserAPI/GetUser", runtime.WithHTTPPathPattern("/users/{user_id}"))
		if err != nil {
		...
		forward_UserAPI_GetUser_0(ctx, mux, outboundMarshaler, w, req, response_UserAPI_GetUser_0{resp}, mux.GetForwardResponseOptions()...)
...
func RegisterUserAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UserAPIClient) error {
	...
	mux.Handle("GET", pattern_UserAPI_GetUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/core.v1.UserAPI/GetUser", runtime.WithHTTPPathPattern("/users/{user_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
type response_UserAPI_GetUser_0 struct {
	proto.Message
}

func (m response_UserAPI_GetUser_0) XXX_ResponseBody() interface{} {
	response := m.Message.(*GetUserResponse)
	return response.User
}

var (
	pattern_UserAPI_GetUser_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"users", "user_id"}, ""))
)
